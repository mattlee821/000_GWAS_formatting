...
TRAIT=liver-volume_combined_UKB
...
TRAIT=spleen-volume_combined_UKB
wget -O docs/README_${TRAIT}.txt ${URL}${ACCESSION}${STUDY}${README}
wget -O raw/${TRAIT}.gz ${URL}${ACCESSION}${STUDY}${GWAS}
...
TRAIT=lung-volume_combined_UKB
wget -O docs/README_${TRAIT}.txt ${URL}${ACCESSION}${STUDY}${README}
wget -O raw/${TRAIT}.gz ${URL}${ACCESSION}${STUDY}${GWAS}
...
TRAIT=pancreas-volume_combined_UKB
wget -O docs/README_${TRAIT}.txt ${URL}${ACCESSION}${STUDY}${README}
wget -O raw/${TRAIT}.gz ${URL}${ACCESSION}${STUDY}${GWAS}
...
TRAIT=kidney-volume_combined_UKB
wget -O docs/README_${TRAIT}.txt ${URL}${ACCESSION}${STUDY}${README}
wget -O raw/${TRAIT}.gz ${URL}${ACCESSION}${STUDY}${GWAS}
...
TRAIT=VAT-measurement_combined_UKB
wget -O docs/README_${TRAIT}.txt ${URL}${ACCESSION}${STUDY}${README}
wget -O raw/${TRAIT}.gz ${URL}${ACCESSION}${STUDY}${GWAS}
...
TRAIT=SAT-measurement_combined_UKB
wget -O docs/README_${TRAIT}.txt ${URL}${ACCESSION}${STUDY}${README}
wget -O raw/${TRAIT}.gz ${URL}${ACCESSION}${STUDY}${GWAS}
...
TRAIT=liver-fat-measurement_combined_UKB
wget -O docs/README_${TRAIT}.txt ${URL}${ACCESSION}${STUDY}${README}
wget -O raw/${TRAIT}.gz ${URL}${ACCESSION}${STUDY}${GWAS}
...
TRAIT=pancreas-fat-measurement_combined_UKB
wget -O docs/README_${TRAIT}.txt ${URL}${ACCESSION}${STUDY}${README}
wget -O raw/${TRAIT}.gz ${URL}${ACCESSION}${STUDY}${GWAS}

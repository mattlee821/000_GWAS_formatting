...
export DIRECTORY="/data/GWAS_data/work/000_GWAS_formatting/zhang_2022_PMID35501419/002_standardise/002_standardise/"

# Define the list of ancestry folders
ancestry_folders=("filelist_test" "filelist_european" "filelist_african-american")

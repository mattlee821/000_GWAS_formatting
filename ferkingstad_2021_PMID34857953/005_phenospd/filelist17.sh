...
for file in `cat filelist17`; do
    ...
    join --nocheck-order -a1 -a2  -1 1 -2 3 -e 'NA' -o '2.7,2.10' ../work/snp_list ${file}.unzipped > filelist17.${file}.unzipped

    rm ${file}.unzipped 
done

paste -d " " ../work/snp_list filelist17.* > results.filelist17
rm filelist17.*

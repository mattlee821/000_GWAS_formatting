...
for file in `cat filelist15`; do
    ...
    join --nocheck-order -a1 -a2  -1 1 -2 3 -e 'NA' -o '2.7,2.10' ../work/snp_list ${file}.unzipped > filelist15.${file}.unzipped

    rm ${file}.unzipped 
done

paste -d " " ../work/snp_list filelist15.* > results.filelist15
rm filelist15.*

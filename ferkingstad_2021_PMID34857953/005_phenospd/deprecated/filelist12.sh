...
for file in `cat filelist12`; do
    ...
    join --nocheck-order -a1 -a2  -1 1 -2 3 -e 'NA' -o '2.7,2.10' ../work/snp_list ${file}.unzipped > filelist12.${file}.unzipped

    rm ${file}.unzipped 
done

paste -d " " ../work/snp_list filelist12.* > results.filelist12
rm filelist12.*

...
for file in `cat filelist11`; do
    ...
    join --nocheck-order -a1 -a2  -1 1 -2 3 -e 'NA' -o '2.7,2.10' ../work/snp_list ${file}.unzipped > filelist11.${file}.unzipped

    rm ${file}.unzipped 
done

paste -d " " ../work/snp_list filelist11.* > results.filelist11
rm filelist11.*

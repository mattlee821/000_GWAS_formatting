...
for file in `cat filelist19`; do
    ...
    join --nocheck-order -a1 -a2  -1 1 -2 3 -e 'NA' -o '2.7,2.10' ../work/snp_list ${file}.unzipped > filelist19.${file}.unzipped

    rm ${file}.unzipped 
done

paste -d " " ../work/snp_list filelist19.* > results.filelist19
rm filelist19.*

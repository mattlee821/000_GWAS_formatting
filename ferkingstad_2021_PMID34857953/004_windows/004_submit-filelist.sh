...
export DIRECTORY="/data/GWAS_data/work/000_GWAS_formatting/ferkingstad_2021_PMID34857953/004_windows/filelist/"
cd ${DIRECTORY}

chmod u+w /data/GWAS_data/work/ferkingstad_2021_PMID34857953/

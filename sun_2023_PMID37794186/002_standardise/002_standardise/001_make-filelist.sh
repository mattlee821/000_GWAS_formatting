...
ancestries=("african"  "american"  "central-south-asian"  "combined"  "east-asian"  "european"  "middle-east" "test")
...
for ancestry in "${ancestries[@]}"; do
    ...
    ls /data/GWAS_data/files/${ID}/processed/${DIRECTORY_ANCESTRY}/*gz > filenames

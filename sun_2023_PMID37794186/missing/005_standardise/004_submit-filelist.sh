...
export DIRECTORY="/data/GWAS_data/work/000_GWAS_formatting/sun_2023_PMID37794186/missing/005_standardise/"

# Define the list of ancestry folders
ancestry_folders=("filelist_african" "filelist_central-south-asian" "filelist_east-asian" "filelist_american" "filelist_combined")
ancestry_folders=("filelist_central-south-asian")

...
cd /data/GWAS_data/work/000_GWAS_formatting/pietzner_2021_PMID34648354/004_windows/
mkdir -p filelist

export PATH_OUT="/data/GWAS_data/work/000_GWAS_formatting/pietzner_2021_PMID34648354/004_windows/filelist/"
export FILE_OUT_PREFIX="filelist-"
find "${PATH_OUT}" -name "filelist-*" -type f -exec rm {} +
find "${PATH_OUT}" -name "slurm-*" -type f -exec rm {} +
export FILE_IN="/data/GWAS_data/work/000_GWAS_formatting/pietzner_2021_PMID34648354/004_windows/files.txt"
...
while IFS= read -r sh_file; do 
    ...
    awk -v fname="$base_filename" '{
        if (NR == 3) 
            ...
            print "FILE_IN=\"/data/GWAS_data/work/000_GWAS_formatting/pietzner_2021_PMID34648354/004_windows/filelist/" fname "\""; 
        else if (NR == 12)
            print "WINDOW=1000000";
        else
            print $0
    }' 002_master.sh > "${sh_file}.sh"  # Output file for version 1

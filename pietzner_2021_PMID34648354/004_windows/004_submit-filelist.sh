...
export DIRECTORY="/data/GWAS_data/work/000_GWAS_formatting/pietzner_2021_PMID34648354/004_windows/filelist/"
cd ${DIRECTORY}

chmod u+w /data/GWAS_data/work/pietzner_2021_PMID34648354/
